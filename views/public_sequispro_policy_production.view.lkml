view: public_sequispro_policy_production {
  sql_table_name: `reporting.public_sequispro_policy_production` ;;
  drill_fields: [id]
  ...
  measure: count {
    type: count
    drill_fields: [id, branch_name, region_name, branch_short_name, policy_name]
  }
}
