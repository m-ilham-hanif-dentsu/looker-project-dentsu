view: cm_abp_raw {
  sql_table_name: `reporting.cm_abp_raw` ;;
  ...
  dimension: total_direct_withdrawal {
    type: number
    sql: ${TABLE}.total_direct_withdrawal ;;
  }
  dimension: total_personal_withdrawal {
    type: number
    sql: ${TABLE}.total_personal_withdrawal ;;
  }
